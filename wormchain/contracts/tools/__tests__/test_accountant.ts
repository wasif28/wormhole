...
const TENDERMINT_URL = `http://${ci ? "wormchain" : "localhost"}:26659`;
const GA_ADDRESS =
...
describe("Global Accountant Tests", () => {
  test("Metrics and Contract Queries", async () => {
    ...
    //
    {
      ...
      expect(afterBscBalance.valueOf()).toBeGreaterThan(
        beforeBscBalance.valueOf()
      );
    }
    ...
    //
    {
      ...
      expect(afterBscBalance.valueOf()).toBeLessThan(
        beforeBscBalance.valueOf()
      );
    }
