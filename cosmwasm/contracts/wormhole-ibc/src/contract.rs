...
use semver::Version;
use wormhole::msg::{ExecuteMsg, MigrateMsg, InstantiateMsg};
...
const WORMCHAIN_IBC_RECEIVER_PORT: &str = "wasm.wormhole1nc5tatafv6eyq7llkr2gv50ff9e22mnf70qgjlv737ktmt4eswrq0kdhcj";
...
pub fn execute(
    ...
    match msg {
        ExecuteMsg::SubmitVAA { .. } => wormhole::contract::execute(deps, env, info, msg).context("failed core submit_vaa execution"),
...
fn post_message_ibc(
    ...
    let packet_timeout = Timestamp::from_seconds(0).into();
